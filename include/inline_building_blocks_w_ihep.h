...
#ifndef __inline_building_blocks_ihep_h__
#define __inline_building_blocks_ihep_h__
...
//! Parameter structure
/*! \ingroup inlinehadron */
struct InlineBuildingBlocksIHEPParams {
  InlineBuildingBlocksIHEPParams();
  InlineBuildingBlocksIHEPParams(XMLReader &xml_in, const std::string &path);
  ...
  struct Param_t {
    ...
    bool
    translate; /*!< Shifts the BB correlator output to start at t_source as 0*/
...
private:
  InlineBuildingBlocksIHEPParams params;
};
}

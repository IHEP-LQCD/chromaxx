...
#ifndef __tset_inline_meson_matelem_colorvec_h__
#define __test_inline_meson_matelem_colorvec_h__
...
struct Params {
  ...
  struct Param_t {
    ...
    int
    displacement_length; /*!< Displacement length for creat. and annih. ops */
    int num_vecs;        /*!< Number of color vectors to use */
    int decay_dir;       /*!< Decay direction */
    multi1d<multi1d<int> > displacement_list; /*!< Array of displacements list
                                                 to generate */

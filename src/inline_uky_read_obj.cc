...
{ 
  ...
  { 
			   ...
			   XMLWriter& xml_out) 
    {
      ...
      QDPIO::cout << "Attempt to read file name = " << params.file.file_name << std::endl;
...
//      TheUKYReadObjFuncMap::Instance().dump();
	...
	// Read the object
	swatch.start();
	UKYReadObjCallMapEnv::TheUKYReadObjFuncMap::Instance().callFunction(params.named_obj.object_type,
